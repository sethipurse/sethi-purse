...
const SLIDES = [
  {
    category: 'LUGGAGE',
    headline: 'Travel\nBeyond',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-1-luggage_jpg.png',
    badges: ['Free Delivery', '10 Year Warranty', 'Easy Returns'],
  },
  {
    category: 'LUGGAGE',
    headline: 'Premium\nTrolleys',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-2-luggage_jpg.png',
    badges: ['Free Delivery', '10 Year Warranty', 'Easy Returns'],
  },
  {
    category: 'HANDBAGS',
    headline: 'Elegance\nEveryday',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-3-handbag_jpg.png',
    badges: ['Premium Quality', 'Secure Checkout', 'Timeless Design'],
  },
  {
    category: 'HANDBAGS',
    headline: 'Style\nRedefined',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-4-handbag_jpg.png',
    badges: ['Premium Quality', 'Secure Checkout', 'Timeless Design'],
  },
  {
    category: 'SCHOOL BAGS',
    headline: 'Ready\nFor More',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-5-schoolbag_jpg.png',
    badges: ['Spacious Storage', 'Durable Build', 'Water Resistant'],
  },
  {
    category: 'SCHOOL BAGS',
    headline: 'Built\nTo Last',
    image: 'https://bbdatviaaiqpfvwumkkd.supabase.co/storage/v1/object/public/products/slider-6-schoolbag_jpg.png',
    badges: ['Spacious Storage', 'Durable Build', 'Water Resistant'],
  },
];
    ...
    <div style={S.card}>
      ...
      <div style={S.slideArea}>
        <div style={S.textBlock}>
          <p style={S.category}>{slide.category}</p>
...
const S = {
  ...
  textBlock: { padding: '16px 26px 0', position: 'relative', zIndex: 2 },
  ...
  imageWrap: { position: 'absolute', bottom: 44, left: 0, right: 0, height: 300, zIndex: 1 },

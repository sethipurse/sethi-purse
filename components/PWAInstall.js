...
export default function PWAInstall() {
  ...
  useEffect(() => {
    ...
    // Only show install banner when browser fires the prompt — no bell button
  ...
  // ✅ FIX: No bell button at all — it was showing on desktop and cluttering the UI.
  // Push notifications only work when explicitly triggered, not via a floating bell.
  // The install banner only appears when the browser itself decides to prompt (rare).
  if (!show) return null;

...
export const SHOP_INTENT_TERMS = [
  'bag', 'bags', 'purse', 'purses', 'attachi', 'attache', 'ਅਟੈਚੀ', 'ਬੈਗ', 'ਪਰਸ',
...
export const FAMILY_INTENT_TERMS = {
  purse: ['purse', 'purses', 'handbag', 'wallet', 'sling', 'ਪਰਸ'],
  backpack: ['backpack', 'school', 'college'],
  luggage: ['luggage', 'trolley', 'suitcase', 'attachi', 'attache', 'ਅਟੈਚੀ', 'cabin', 'travel', 'trip'],
};

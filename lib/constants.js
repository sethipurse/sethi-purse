...
// Admin-only WhatsApp quick-action templates (app/admin/inquiries/page.js).
// Leave GOOGLE_REVIEW_LINK empty until the owner has a review link to share —
// the review quick-action stays hidden until it's filled in.
export const GOOGLE_REVIEW_LINK = '';
export const FOLLOWUP_TEMPLATE = 'Sat Sri Akal ji! 🙏 Aapne {product} ke baare mein poochha tha — abhi available hai. Aana ho ya koi sawaal ho toh batayein 😊 — SETHI PURSE';
export const REVIEW_REQUEST_TEMPLATE = 'Thank you ji! 🙏 Bag pasand aaya ho toh 30 second nikaal ke Google pe review de dena: {link} Aapke review se hamari dukaan ko bahut madad milti hai ❤️ — SETHI PURSE';
export const PRICE_DROP_DEMAND_NOTE = 'In products pe price girao to sabse zyada log wapas aayenge 🔔';

...
// ── Category dropdown — pulls from /api/categories, prevents typos ─────────
function CategorySelect({ value, onChange, categories }) {
  return (
    <div>
      ...
      <p className="text-xs text-sethi-gray500 mt-1">
        Select a category to link this slide to it, or leave as "No category" to open all products.
      </p>
    </div>
  );
}
                ...
                <li key={slide.id} className="p-4 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-sethi-gray500 mt-0.5">
                      {slide.category ? <span>Category: {slide.category} · </span> : <span>All products · </span>}
